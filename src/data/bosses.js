...
export const CIPHER_BOSS = Object.freeze({
  ...
  attacks: Object.freeze({
    puzzleInterval: 3.05,
    corruptedInterval: 2.2,
    finalPuzzleInterval: 1.65,
    finalCombatInterval: 1.25,
    beam: Object.freeze({
      warningDuration: 1.44,
      duration: 3.1,
      angularSpeed: 1.08,
      halfWidth: 0.095,
      range: 780,
