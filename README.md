...
- Selecting an unlocked Captain in the Captain selection menu immediately confirms the choice and closes the menu
...
- Boss Caches award 150% of the current next-level XP requirement before global XP scaling, plus 12 Gold, and require 2.5 seconds of accumulated capture; partial capture progress remains when the squad steps away and returns
- Treasure Chests generated by the permanent Treasure Chests upgrade open instantly when collected, always award 25 XP + 2 Gold, and use higher upgrade ranks only to increase drop chance; Crawlers and Runners cannot drop these chests
